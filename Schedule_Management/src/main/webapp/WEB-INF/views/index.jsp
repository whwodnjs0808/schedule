      ...
      <div class="container-fluid">
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-primary o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">게시판에서 자유롭게 글을 남기세요!</div>
              </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-warning o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">자신의 일정을 달력에 기록하세요!</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="#">
              </a>
            </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-success o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">지금바로 일정을 확인하세요!</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="#">
              </a>
            </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">여기는 <b> Schedule_Management 입니다! </b></div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="#">
              </a>
            </div>
        ...
        <div class="card mb-3">
          <div class="card-body">
            ...
            <img alt="" src="/resources/img/mainimg.jpg" width="100%" height="">
          </div>
        </div>
