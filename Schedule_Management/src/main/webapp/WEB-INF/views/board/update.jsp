...
<style type="text/css">
	...
	#cancle{background-color:#dd4b39; border-color:#d73925;}
    ...
    <div id="content-wrapper">
      ...
      <div class="box-body">
   	 	...
   	 	<div class="form-group">
      		<label>Bno</label>
      		<input type="text" name="bno" class="form-control" value="${item.bno}" readonly="readonly">
      	</div>
      	...
      	<div class="form-group">
   		...
   		<div class="form-group">
      		...
      		<textarea type="text" name="contents" class="form-control">${item.contents }</textarea>
      	</div>
      	<div class="form-group">
      		<label>Writer</label>
      		<input type="text" readonly="readonly" name="userid" class="form-control" value="${item.userid}">
      	</div>
      	<div class="box-footer">
      	<input type="submit" class="btn btn-primary" value="수정">
      	<input type="button" class="btn btn-warning" id="cancle" value="취소">
      </div>
      </div>
      </form>
